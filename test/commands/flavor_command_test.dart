...
/// Minimal project.pbxproj with all required sections.
/// XCConfigurationList is placed before PBXNativeTarget so that
/// _extractConfigsFromList finds the list definition first.
final _pbxproj = '// !\$*UTF8*\$!\n'
    '{\n'
    '\tarchiveVersion = 1;\n'
    '\tobjects = {\n'
